...
5. Hostinge viešinkite tik HTML puslapius bei `assets`, `css` ir `Nuotraukos` katalogus. Neviešinkite `.env`, `supabase`, `tests`, Python failų ar projekto įrankių katalogų.
